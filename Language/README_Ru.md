...
## Окружение
- **ОС:** Windows 11 и Linux (Zorin OS)
- **Редактор:** VS Code и Antigravity
- **Языки:** Python, HTML, CSS, JS, Odin, Java, C#, Lua

## Привет!
Привет! Я Minta (Minta1234), интересуюсь Linux, Windows, кибербезопасностью и Blender.
...
- **VS Code:** Создаю сайты и обновляю их

<details>
<summary>Скриншот Linux</summary>
