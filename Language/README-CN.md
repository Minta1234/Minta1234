...
## 环境
- **操作系统:** Windows 11 与 Linux (Zorin OS)
- **编辑器:** VS Code 与 Antigravity
- **编程语言:** Python, HTML, CSS, JS, Odin, Java, C#, Lua

## 你好！
你好！我是 Minta（Minta1234），对 Linux、Windows、网络安全、Blender 感兴趣。
